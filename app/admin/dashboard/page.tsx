    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="border-b border-gray-200 pb-5">
        ...
        <p className="text-sm text-gray-500 mt-2">
          สถิติการเข้าชมเว็บไซต์และการใช้งานระบบทั้งหมด
        </p>
      </div>
      ...
      <div className="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden flex flex-col">
        <div className="px-6 py-5 border-b border-gray-100 bg-gray-50/50">
          <h3 className="font-bold text-gray-800 text-lg">
            ประวัติการใช้งานระบบ 20 รายการล่าสุด
          </h3>
        </div>
                  ...
                  <td className="px-6 py-4 font-bold">
                    <span
                      className={`px-3 py-1 rounded-full text-[10px] uppercase tracking-wider ${
                        log.ActionType === "COOKIE_ACCEPT"
                          ? "bg-green-100 text-green-700"
                          : log.ActionType === "PAGE_VISIT"
