...
export default function CompanyActivityPage() {
  ...
  useEffect(() => {
    ...
    const fetchActivities = async () => {
      const res = await fetch("/api/admin/activities?category=company");
      ...
      {selectedAlbum && (
        ...
        >
          ...
          >
            ...
            {albumImages.length > 0 ? (
              <div className="relative w-full aspect-video md:aspect-videoflex items-center justify-center mt-12 md:mt-0">
                <Image
